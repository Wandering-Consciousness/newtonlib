...
# define EXPORTED
	...
	struct Coordinate {
		struct LatLng point;
		struct DistanceBearring bearing; //how it was calculated
	};

	const struct LatLng Moscow = { 55.751244 , 37.618423 };
	const struct LatLng Paris = { 48.864716 , 2.349014 };
	const struct LatLng London = { 51.509865 , -0.118092 };
	...
	const unsigned int POINT_ENTROPY_HEX = 26; //string hex representation
